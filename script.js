const malla = [
  ...
  },
  {
    ...
    cursos: [
      ...
      { codigo: "FI1100", nombre: "Física Moderna", prerq: ["FI1000"] },
  ...
  },
  {
    nombre: "V Semestre",
    cursos: [
      { codigo: "MA3603", nombre: "Probabilidades y Estadística", prerq: ["MA2001"] },
  ...
  },
  {
    nombre: "VI Semestre",
    cursos: [
      { codigo: "ME3260", nombre: "Cinemática y Dinámica de Mecanismos", prerq: ["MA2601", "FI2001"] },
      { codigo: "ME3210", nombre: "Materiales para Ingeniería", prerq: ["ME3110"] },
      { codigo: "ME3150", nombre: "Termotecnia", prerq: ["ME3140"] },
      { codigo: "ME3220", nombre: "Mecánica de Sólidos", prerq: ["ME3130", "MA2002"] },
  ...
  },
  {
    ...
    cursos: [
      ...
      { codigo: "ME4230", nombre: "Automatización y Control", prerq: ["ME3250"] },
  ...
  },
  {
    ...
    cursos: [
      { codigo: "ME4260", nombre: "Máquinas", prerq: ["ME4140"] },
      { codigo: "ME4250", nombre: "Mecatrónica", prerq: ["ME4150", "FI2002"] },
      { codigo: "ME4270", nombre: "Elementos de Máquinas", prerq: ["ME3230"] },
      { codigo: "ME4210", nombre: "Planos", prerq: ["ME3220"] },
  ...
  },
  {
    ...
    cursos: [
      ...
      { codigo: "IN4273", nombre: "Gestión de Operaciones", prerq: ["ME4262", "ME4110"] },
      { codigo: "ME5140", nombre: "Ingeniería en Termofluidos", prerq: ["ME4240", "ME4262"] },
      { codigo: "ME5130", nombre: "Robótica", prerq: ["ME4150"] },
  ...
  },
  {
    ...
    cursos: [
      ...
      { codigo: "ME5240", nombre: "Laboratorio de Energía", prerq: ["ME5140"] },
      { codigo: "ME5902", nombre: "Práctica Profesional" }
    ]
  },
  {
    nombre: "XI Semestre",
    cursos: [
      { codigo: "ME6090", nombre: "Trabajo de Título", prerq: ["ME5220"] },
